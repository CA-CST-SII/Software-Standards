...
| Sixth Edition | February 2006 | ? Changed named references to IRS/OPS/SIO/API/DM Branch from Data Administration to Data Management (DM)? Added Appendix B (Oracle and SQL Server - Database Naming Guidelines) and Appendix C (Document Revision History Detail)? Refer to Appendix C for detailed history of changes made to this document |
| Seventh Edition | October 2010 | ? Changed named references from IRS/OPS/SIO/API/DM Branch to IRS/OPS/SIO/APD/DM? Changed DM Email address? Changed the requirement for general Naming rules? Added general naming Principal section? Deleted Acronyms and Abbreviations section of the document? Updated Naming and description section for the following: Entity, Attribute, Column, Table, View and relationship, Index and Triggers? Added New data Objects and naming standard for Constraints and Stored Procedure |
