...
- [4 Naming Conventions](#4-naming-conventions)
  ...
  - [4.3 BPEL Activities](#43-bpel-activities)
    ...
    - [4.3.3 Compensate](#433-compensate)
    - [4.3.4 Flow](#434-flow)
...
- [5 Fault Handling](#5-fault-handling)
  ...
  - [5.3 Typical Fault Handling Flow](#53-typical-fault-handling-flow)
  - [5.4 BPEL Activities to propagate a fault](#54-bpel-activities)
    - [5.4.1 Throw](#432-throw)
    - [5.4.2 Rethrow](#432-rethrow)
    - [5.4.3 Reply with a fault](#432-reply-with-a-fault)
...
- [7 Simple coding guidelines](#43-bpel-activities)	
  ...
  - [7.2 Avoid missing otherwise in switch statements](#72-avoid-missing-otherwise-in-switch-statements)
  - [7.3 Avoid using invoke without catch](#73-avoid-using-invoke-without-catch)
  - [7.4 Create Scopes For Each Step Of the Flow in the Process](#74-create-scopes-for-each-step-of-the-flow-in-the-process)
  ...
  - [7.24 Adapters Should Be Defined As An ESB Service For Reusability Standards.](#724-adapters-should-be-defined)
  - [7.25 Externalize Security From Service Providers And Consumers Through Agents And Gateways for IT Security.](#725-externalize-security-from-service-providers-and-consumers)
  - [7.26 Do Not Use A File Adaptor For Logging For Debugging Purposes.](#726-do-not-use-a-file-adaptor-for-logging-for-debugging-purposes.)
- [8 Code Examples](#8-code-examples)	
- [9 Leading Practices For Success Of BPEL Implementation](#9-leading-practices-for-success-of-bpel-implementation)
  - [9.1 Assessments and Maturity Models](#91-assessments-and-maturity-models)
  - [9.2 A Strategic Roadmap and Tactical Plan](#92-a-strategic-roadmap-and-tactical-plan)
  - [9.3 Avoid Interruptible Processes](#93-avoid-interruptible-processes)
  - [9.4 Agile Methods and Processes](#94-agile-methods-and-processes)
  - [9.5 Governance](#95-governance)
